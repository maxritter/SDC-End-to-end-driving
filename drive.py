...
set_speed = 15 # Set speed to 25 for track 1, 15 for track 2, 20 for track 3
...
def telemetry(sid, data):
    if data:
		...
		# Crop the image
        image_cropped = image_array[50:140, 0:320]
        ...
        # Amplification for track 1
        #steering_angle *= 0.70
        # Amplification for track 2 & track 3
        steering_angle *= 1.5
